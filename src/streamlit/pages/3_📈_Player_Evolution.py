...
st.set_page_config(page_title="Futpeak | Evolution", layout="wide", initial_sidebar_state="expanded")
apply_background()
...
st.title("📈 Player Evolution")
st.write("Visualize how a player's metrics have evolved season by season.")
