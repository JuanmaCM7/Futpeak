...
st.set_page_config(page_title="Futpeak | Projection", layout="wide", initial_sidebar_state="expanded")
apply_background()
...
st.title("🔮 Projection")
st.write("Forecast future performance of players using machine learning.")
