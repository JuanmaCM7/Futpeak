...
import os
import pandas as pd
import time  # Asegúrate de tenerlo importado al principio
...
with col1:
    try:
        with st.spinner("Cargando imagen y perfil..."):
            time.sleep(0.5)
...
with col2:
    ...
    try:
        with st.spinner("Cargando gráfica de producción ofensiva..."):
            time.sleep(0.5)
    ...
    try:
        with st.spinner("Cargando gráfica de minutos..."):
            time.sleep(0.5)
...
with col3:
    ...
    try:
        with st.spinner("Cargando proyección..."):
            time.sleep(0.5)
